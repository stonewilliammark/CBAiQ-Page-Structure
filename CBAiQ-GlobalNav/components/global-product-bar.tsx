        ...
        <div className="flex items-center">
          <Link href="/insight-feed" className="hover:opacity-80 transition-opacity">
            <span className="text-[24px] font-semibold">
              <span className="text-[#ffcc01]">Comm</span>
              <span className="text-[#424247]">Bank iQ</span>
            </span>
          </Link>
        </div>
      </div>
      <div className="ml-auto flex items-center gap-2">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="flex items-center gap-1 px-2 py-1 font-normal text-[#424247]">
        ...
        <Button variant="ghost" size="icon" className="text-[#424247]">
